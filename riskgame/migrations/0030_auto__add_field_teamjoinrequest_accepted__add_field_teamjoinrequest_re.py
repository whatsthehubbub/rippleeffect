...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamJoinRequest.accepted'
        db.add_column(u'riskgame_teamjoinrequest', 'accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TeamJoinRequest.rejected'
        db.add_column(u'riskgame_teamjoinrequest', 'rejected',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TeamJoinRequest.datedecided'
        db.add_column(u'riskgame_teamjoinrequest', 'datedecided',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamJoinRequest.accepted'
        db.delete_column(u'riskgame_teamjoinrequest', 'accepted')

        # Deleting field 'TeamJoinRequest.rejected'
        db.delete_column(u'riskgame_teamjoinrequest', 'rejected')

        # Deleting field 'TeamJoinRequest.datedecided'
        db.delete_column(u'riskgame_teamjoinrequest', 'datedecided')
    ...
    models = {
        ...
        u'riskgame.team': {
            ...
            'goal_zero_streak': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leader': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'ledteam'", 'null': 'True', 'to': u"orm['riskgame.Player']"}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
        ...
        u'riskgame.teamjoinrequest': {
            ...
            'datechanged': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'datecreated': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'datedecided': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'riskgame.teamplayer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lightning_hit': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['riskgame.Player']"}),
