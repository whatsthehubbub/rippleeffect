...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TeamJoinRequest.confirmed'
        db.delete_column(u'riskgame_teamjoinrequest', 'confirmed')

        # Adding field 'TeamJoinRequest.role'
        db.add_column(u'riskgame_teamjoinrequest', 'role',
                      self.gf('django.db.models.fields.CharField')(default='office', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TeamJoinRequest.confirmed'
        db.add_column(u'riskgame_teamjoinrequest', 'confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'TeamJoinRequest.role'
        db.delete_column(u'riskgame_teamjoinrequest', 'role')
