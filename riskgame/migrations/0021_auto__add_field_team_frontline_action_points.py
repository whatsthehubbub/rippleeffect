...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.frontline_action_points'
        db.add_column(u'riskgame_team', 'frontline_action_points',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.frontline_action_points'
        db.delete_column(u'riskgame_team', 'frontline_action_points')
