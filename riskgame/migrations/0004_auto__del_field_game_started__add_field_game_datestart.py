...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'riskgame_game', 'started')

        # Adding field 'Game.datestart'
        db.add_column(u'riskgame_game', 'datestart',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Game.started'
        db.add_column(u'riskgame_game', 'started',
