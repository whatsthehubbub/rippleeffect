...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamPlayer.show_game_start'
        db.add_column(u'riskgame_teamplayer', 'show_game_start',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TeamPlayer.show_episode_start'
        db.add_column(u'riskgame_teamplayer', 'show_episode_start',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TeamPlayer.show_turn_start'
        db.add_column(u'riskgame_teamplayer', 'show_turn_start',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamPlayer.show_game_start'
        db.delete_column(u'riskgame_teamplayer', 'show_game_start')

        # Deleting field 'TeamPlayer.show_episode_start'
        db.delete_column(u'riskgame_teamplayer', 'show_episode_start')

        # Deleting field 'TeamPlayer.show_turn_start'
        db.delete_column(u'riskgame_teamplayer', 'show_turn_start')
