...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamPlayer.episode_events'
        db.add_column(u'riskgame_teamplayer', 'episode_events',
        ...
        # Adding field 'Episode.number'
        db.add_column(u'riskgame_episode', 'number',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamPlayer.episode_events'
        db.delete_column(u'riskgame_teamplayer', 'episode_events')
        ...
        db.add_column(u'riskgame_team', 'currentDay',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['riskgame.EpisodeDay'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Episode.number'
        db.delete_column(u'riskgame_episode', 'number')
