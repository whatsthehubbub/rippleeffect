...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'riskgame_team', 'leader',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='ledteam', null=True, to=orm['riskgame.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.leader'
        db.delete_column(u'riskgame_team', 'leader_id')
