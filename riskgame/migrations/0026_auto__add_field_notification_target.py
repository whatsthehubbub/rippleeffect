...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'riskgame_notification', 'target',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['riskgame.Player']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.target'
        db.delete_column(u'riskgame_notification', 'target_id')
