...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'riskgame_game', 'end',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 4, 4, 0, 0)),
                      keep_default=False)

        # Adding field 'EpisodeDay.current'
        db.add_column(u'riskgame_episodeday', 'current',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'riskgame_game', 'end')

        # Deleting field 'EpisodeDay.current'
        db.delete_column(u'riskgame_episodeday', 'current')
