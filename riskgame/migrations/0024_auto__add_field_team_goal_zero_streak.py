...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Team.goal_zero_streak'
        db.add_column(u'riskgame_team', 'goal_zero_streak',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Team.goal_zero_streak'
        db.delete_column(u'riskgame_team', 'goal_zero_streak')
