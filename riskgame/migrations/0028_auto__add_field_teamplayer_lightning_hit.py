...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TeamPlayer.lightning_hit'
        db.add_column(u'riskgame_teamplayer', 'lightning_hit',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TeamPlayer.lightning_hit'
        db.delete_column(u'riskgame_teamplayer', 'lightning_hit')
